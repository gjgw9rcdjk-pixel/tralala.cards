...
const DESCRIPTION_BY_LANG = {
  en: "200 conversation cards and icebreaker questions for friends, couples, parties, teams and road trips. Free to play, with no account or setup.",
  lt: "200 pokalbių kortelių ir pažinties klausimų draugams, poroms, vakarėliams, komandoms ir kelionėms. Žaisk nemokamai, be paskyros ir nustatymų.",
  de: "200 Gesprächskarten und Eisbrecherfragen für Freunde, Paare, Partys, Teams und Roadtrips. Kostenlos spielen, ohne Konto und Einrichtung.",
  es: "200 cartas de conversación y preguntas para romper el hielo, para amigos, parejas, fiestas, equipos y viajes. Gratis, sin cuenta ni configuración.",
  it: "200 carte per conversazioni e domande rompighiaccio per amici, coppie, feste, team e viaggi. Gratis, senza account e senza configurazione.",
  pl: "200 kart do rozmów i pytań na przełamanie lodów dla przyjaciół, par, imprez, zespołów i podróży. Graj za darmo, bez konta i konfiguracji.",
};
