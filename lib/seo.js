...
const DESCRIPTION_BY_LANG = {
  en: '150+ fun, deep and unexpected conversation starters for friends, couples, parties, teams and road trips. Free to play — no account, no setup.',
  lt: '150+ linksmų, gilių ir netikėtų klausimų draugams, poroms, vakarėliams ir komandoms. Žaisk nemokamai — be paskyros, be nustatymo.',
  de: '150+ lustige, tiefgründige und unerwartete Fragen für Freunde, Paare, Partys und Teams. Kostenlos spielen — kein Konto nötig.',
  es: 'Más de 150 preguntas divertidas, profundas e inesperadas para amigos, parejas y fiestas. Juega gratis, sin cuenta ni configuración.',
  it: 'Oltre 150 domande divertenti, profonde e inaspettate per amici, coppie e feste. Gioca gratis — senza account, senza configurazione.',
  pl: 'Ponad 150 zabawnych, głębokich i nieoczekiwanych pytań dla przyjaciół, par i imprez. Graj za darmo — bez konta, bez konfiguracji.',
};
